...
<body> 
    ...
    <div class="container"> 
        ...
        $conexion = new mysqli($db_host, $db_user, $db_pass, $db_name); // --- 3. Verificar si la conexión fue exitosa --- 
        if ($conexion->connect_error) { 
            // die() detiene la ejecución del script y muestra un mensaje 
            die("<div class='error-message'>❌ Error de conexión: " . $conexion
>connect_error . "</div>"); 
        } 
        ...
        $sql = "SELECT Nombre, Apellido, Empresa, Domicilio, Ciudad, Pais, Telefono, Email 
FROM clientes"; 
